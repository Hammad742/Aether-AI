...
const AssistantResponse = ({ answer, displayedAnswer, selectedModel }) => {
    ...
    return (
        <div className="bg-gradient-to-br from-zinc-900/80 to-zinc-800/80 border border-zinc-700/50 rounded-2xl p-4 backdrop-blur-sm shadow-2xl sm:p-6">
            {/* Robot avatar/icon */}
            <div className="w-7 h-7 bg-gradient-to-br from-accent-light to-accent-hover rounded-full flex items-center justify-center shrink-0 shadow-lg sm:w-8 sm:h-8">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-col gap-1 mb-2 sm:flex-row sm:items-center sm:gap-2 sm:mb-3">
                    ...
                    <span className="px-2 py-0.5 bg-accent/20 text-accent-light text-xs rounded-full self-start sm:self-auto">
